...
class G1WaistYawLowLevelSimpleTest:
    """Teste de baixo nível simples para WAIST_YAW."""
    
    def __init__(self):
        self.interface = "en11"
        self.time_ = 0.0
        self.control_dt_ = 0.02  # [20ms] - mais lento para simplicidade
    ...
    def LowStateHandler(self, msg: LowState_):
        ...
        self.counter_ +=1
        if (self.counter_ % 50 == 0) :  # A cada 1 segundo (50 * 20ms)
            self.counter_ = 0
    ...
    def run_test(self):
        ...
        print("🦴 TESTE BAIXO NÍVEL SIMPLES: WAIST_YAW")
        print("=" * 60)
...
def main():
    ...
    # Executar teste
    tester = G1WaistYawLowLevelSimpleTest()
